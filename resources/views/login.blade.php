...
<!-- [ auth-signin ] start -->
<div class="auth-wrapper" style="background: #455882">
    <div class="auth-content">
        <div class="card">
            <div class="row align-items-center text-center">
                <div class="col-md-12">
                    <div class="card-body">
                        <h4>Sistem informasi pemberian pelatihan keterampilan di Dinas Sosial</h4>

                        <h5 class="mb-3 f-w-400">Masukkan Username & Password</h5>
                        <br />
