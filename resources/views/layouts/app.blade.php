        ...
        <div class="navbar-wrapper  ">
            <div class="navbar-content scroll-div ">
                ...
                <ul class="nav pcoded-inner-navbar ">
                    ...
                    <li class="nav-item">
                        <a href="/superadmin/peserta" class="nav-link "><span class="pcoded-micon"><i
                                    class="feather icon-list"></i></span><span class="pcoded-mtext">Peserta
                            </span></a>
                    </li>
                    <li class="nav-item">
                        <a href="/superadmin/instruktur" class="nav-link "><span class="pcoded-micon"><i
                                    class="feather icon-list"></i></span><span class="pcoded-mtext">Instruktur
                            </span></a>
                    </li>
                    <li class="nav-item">
                        <a href="/superadmin/jadwal" class="nav-link "><span class="pcoded-micon"><i
                                    class="feather icon-list"></i></span><span class="pcoded-mtext">Jadwal
                            </span></a>
                    </li>


                    <li class="nav-item">
                        <a href="/superadmin/jenis" class="nav-link "><span class="pcoded-micon"><i
                                    class="feather icon-list"></i></span><span class="pcoded-mtext">Jenis Pelatihan
                            </span></a>
                    </li>

                    <li class="nav-item">
                        <a href="/superadmin/pendaftaran" class="nav-link "><span class="pcoded-micon"><i
                                    class="feather icon-list"></i></span><span class="pcoded-mtext">Pendaftaran
                            </span></a>
                    </li>
                    <li class="nav-item">
                        <a href="/superadmin/penyelenggara" class="nav-link "><span class="pcoded-micon"><i
                                    class="feather icon-list"></i></span><span class="pcoded-mtext">Penyelenggara
                            </span></a>
                    </li>
                    <li class="nav-item">
                        <a href="/superadmin/hasil" class="nav-link "><span class="pcoded-micon"><i
                                    class="feather icon-list"></i></span><span class="pcoded-mtext">Hasil Latihan
                            </span></a>
                    </li>
                        ...
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <table width="100%">
                                    <tr>
                                        <td width="10%">
                                            <img src="/logo/kalsel.png" width="50%">
                                        </td>
                                        <td>
                                            <h3 class="m-b-10" style="color: white">Sistem informasi pemberian pelatihan
                                                keterampilan di Dinas Sosial Provinsi Kalimantan Selatan
                                            </h3>
                                        </td>
                                    </tr>
                                </table>
